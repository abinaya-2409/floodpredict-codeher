      ...
      >
        ...
        <div className="flex items-center space-x-3 mb-6">
          ...
          <div>
            ...
            <h2 className="text-2xl font-bold text-fg">How Floody predict Predicts Floods Before They Happen</h2>
          </div>
        </div>
        ...
        <div className="p-4 bg-surface-2/80 border border-line-strong/80 rounded-card mb-6">
          <p className="text-fg-soft text-sm md:text-base leading-relaxed">
            ...
            Floody predict combines upcoming weather forecasts, terrain elevations, drain blockage levels, and past flood records to predict 
