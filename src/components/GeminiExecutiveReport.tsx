  ...
  return (
    ...
    >
      ...
      >
        {isLoading ? (
          <>
            <svg className="w-4 h-4 animate-spin text-fg" viewBox="0 0 24 24" fill="none">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center gap-2 pt-2 border-t border-line-strong/60">
              ...
              <button
                ...
                className="py-2 px-3.5 bg-surface-2 hover:bg-surface-3 text-fg-soft hover:text-fg rounded-full text-xs border border-line-strong/60 transition-colors cursor-pointer"
              >
                Export PDF
              </button>
            </div>
