...
export const GeminiExecutiveReport: React.FC<Props> = ({
  ...
  return (
    <div
      className="fluid-glass rounded-[28px] p-5 shadow-2xl flex flex-col gap-4 border border-purple-500/25 relative overflow-hidden"
    ...
    >
      ...
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-purple-500 via-indigo-500 to-cyan-500 flex items-center justify-center text-white shadow-[0_0_18px_rgba(139,92,246,0.45)] border border-purple-300/40 shrink-0">
          <svg className="w-5 h-5 text-white animate-pulse" fill="none" viewBox="0 0 24 24">
            <path
              ...
              fill="currentColor"
            />
            <circle cx="12" cy="12" fill="#f0fdf4" r="2.5" />
          </svg>
        </div>
      ...
      <button
        ...
        disabled={isLoading}
        className="w-full h-11 px-5 rounded-full bg-gradient-to-r from-purple-600 via-indigo-600 to-cyan-500 hover:brightness-115 active:scale-[0.98] text-white text-xs tracking-wide flex items-center justify-center gap-2 shadow-[0_0_24px_rgba(139,92,246,0.45)] border border-purple-300/30 transition-all font-bold group cursor-pointer disabled:opacity-50"
      ...
      >
        {isLoading ? (
          ...
          <>
            <svg className="w-4 h-4 text-amber-300 group-hover:rotate-12 transition-transform" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="bg-slate-950/80 border border-slate-700/60 rounded-2xl p-4 flex flex-col justify-center min-h-[190px]">
        {report ? (
          <div className="flex flex-col gap-3">
            <div className="flex items-center justify-between border-b border-slate-700/60 pb-2">
              <span className="font-mono text-[11px] text-rose-400 uppercase flex items-center gap-1.5 font-bold">
            ...
            <div className="text-xs text-slate-200 whitespace-pre-line leading-relaxed max-h-80 overflow-y-auto pr-1">
              {report}
            </div>
            ...
            <div className="flex items-center gap-2 pt-2 border-t border-slate-700/60">
              <button
                ...
                className="flex-1 py-2 px-3 bg-gradient-to-r from-rose-500 to-rose-600 hover:brightness-110 text-white rounded-full text-xs uppercase tracking-wider flex items-center justify-center gap-1.5 shadow-[0_0_14px_rgba(244,63,94,0.4)] font-bold cursor-pointer"
              >
              ...
              <button
                ...
                className="py-2 px-3.5 bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white rounded-full text-xs border border-slate-700/60 transition-colors cursor-pointer"
              >
                Export PDF
              </button>
            </div>
          ...
          <div className="flex flex-col items-center justify-center text-center p-3 space-y-2.5">
            <div className="relative w-14 h-14 flex items-center justify-center">
              <svg className="w-14 h-14 text-purple-400/40" fill="none" viewBox="0 0 60 60">
                ...
                <circle cx="30" cy="30" fill="#8b5cf6" fillOpacity="0.7" r="4" />
                <path d="M30 2 L30 58 M2 30 L58 30" stroke="currentColor" strokeOpacity="0.3" strokeWidth="1" />
              </svg>
              <div className="absolute inset-0 flex items-center justify-center">
                <svg className="w-6 h-6 text-cyan-400 animate-pulse" fill="none" stroke="currentColor" strokeWidth="1.75" viewBox="0 0 24 24">
            ...
            <p className="text-[11px] text-slate-400 max-w-[270px] leading-relaxed">
